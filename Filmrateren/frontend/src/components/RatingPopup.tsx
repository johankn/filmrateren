...
function RatingPopup({ onClose, movieID }: RatingPopupProps) {
  ...
  return (
      <body className="grid bg-darkblue bg-opacity-80 rounded-xl p-3 pl-10 pr-10 pb-5">
        <button
          className=" ml-auto text-white hover:text-gold rounded-full p-2 focus:outline-none transition-transform transform hover:scale-125"
          onClick={onClose}
        >
          X
        </button>
